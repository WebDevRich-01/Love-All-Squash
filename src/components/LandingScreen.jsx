...
export default function LandingScreen({
  ...
  const handleInstallClick = async () => {
    ...
    if (success) {
      if (import.meta.env.DEV) console.log('App installed successfully!');
    }
  };
  return (
      ...
      <div className='bg-white p-8 rounded-lg shadow-lg w-full text-center'>
        ...
        <div className='space-y-4'>
          ...
          <button
            ...
            className='w-full py-4 px-6 bg-purple-500 text-white rounded-lg hover:bg-purple-600 font-medium text-lg shadow-sm transition-colors'
          >
            Tournaments
          </button>
